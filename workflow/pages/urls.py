...
urlpatterns = [
    ...
    path('journalist/current-article/<int:task_id>', views.journalist_current_article_view, name='journalist-current-article'),
    ...
    path('editor/current-article/<int:task_id>', views.editor_current_article_view, name='editor-current-article'),
